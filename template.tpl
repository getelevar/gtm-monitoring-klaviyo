...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Elevar Monitoring Klaviyo Tag",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "The Klaviyo Tag adds monitoring to your Klaviyo Tags. Attach KY tag information to your variable errors and notice critical errors immediately.\n\nThe tag is powered by Elevar Monitoring Variables.",
...
[
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "This will be used as the first item in the array for the \"_learnq\" function"
  },
  {
    "type": "TEXT",
    "name": "eventName",
    ...
    "help": "(Optional) If set, this will be used as the second item in the array for the \"_learnq\" function."
  },
  {
    "type": "PARAM_TABLE",
    "name": "content",
    ...
    "help": "This will be converted to an object that will be added to the \"_learnq\" function array as the last item. Each row is a single key value pair."
  }
]
